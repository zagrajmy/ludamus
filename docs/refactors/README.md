...
| 8 | [Dead-end actions (offer it, then refuse it)](dead-end-actions.md) | ✅ done | — (every catalogued dead end fixed; the refusal branches stay for the concurrent-edit race) |
