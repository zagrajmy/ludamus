...
rename_duplicate_track_names = import_module(
    "ludamus.links.db.django.migrations.0149_track_unique_name_per_event"
).rename_duplicate_track_names


@pytest.fixture(name="apps_before_0149")
def apps_before_0149_fixture():
...
class TestRenameDuplicateTrackNames:
    def test_keeps_the_oldest_and_counts_the_rest_up(
        self, event, caplog, apps_before_0149
    ):
        ...
        with caplog.at_level(logging.INFO):
            rename_duplicate_track_names(apps_before_0149, None)
        ...
        assert "0149: 2 tracks renamed" in caplog.text

    def test_skips_counters_already_taken(self, event, apps_before_0149):
    ...
    def test_truncates_to_the_column_width(self, event, apps_before_0149):
        long_name = "a" * 255
    ...
    def test_leaves_distinct_names_and_other_events_alone(
        self, event, sphere, caplog, apps_before_0149
    ):
        ...
        assert "0149: 0 tracks renamed" in caplog.text
