...
class TestTimeSlotDeleteActionView:
    ...
    def test_post_deletes_time_slot_for_manager(self, panel_client, event, time_slot):
        response = panel_client.post(self.get_url(event, time_slot))
    ...
    def test_post_redirects_on_invalid_event_slug(self, panel_client, time_slot):
        url = reverse(
    ...
    def test_post_rejects_slot_from_another_event(self, panel_client, sphere, event):
