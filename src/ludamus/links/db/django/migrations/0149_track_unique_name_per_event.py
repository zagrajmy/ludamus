...
def rename_duplicate_track_names(apps, schema_editor):
    ...
    for track in tracks.iterator():
        ...
        if track.folded_name in taken:
            ...
            renamed += 1
            logger.info("0149: track %s name %r -> %r", track.pk, old_name, track.name)
            taken.add(
    ...
    logger.info("0149: %s tracks renamed", renamed)


class Migration(migrations.Migration):

    dependencies = [("db_main", "0148_facilitator_flag_to_soft_delete")]
