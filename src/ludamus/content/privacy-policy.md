...
- Ustawienia użytkownika (np. wybór szablonu strony)
...
Można żądać informacji o przetwarzanych danych osobowych.

### 7.2 Prawo do sprostowania (art. 16 RODO)

Można żądać poprawienia nieprawidłowych danych.

### 7.3 Prawo do usunięcia danych (art. 17 RODO)

Można żądać usunięcia danych osobowych.

### 7.4 Prawo do ograniczenia przetwarzania (art. 18 RODO)

W określonych przypadkach można żądać ograniczenia przetwarzania.

### 7.5 Prawo do przenoszenia danych (art. 20 RODO)

Można otrzymać swoje dane w ustrukturyzowanym formacie.
...
Konto zostanie usunięte w ciągu 30 dni od otrzymania żądania.
...
- Nieuprawnionym ujawnieniem lub przekazaniem
...
W przypadku naruszenia przepisów o ochronie danych osobowych przysługuje Państwu prawo wniesienia skargi do organu nadzorczego:
...
*Niniejsza polityka prywatności została przygotowana zgodnie z Rozporządzeniem Parlamentu Europejskiego i Rady (UE) 2016/679 z dnia 27 kwietnia 2016 r. (RODO) oraz polskim prawem o ochronie danych osobowych.*
